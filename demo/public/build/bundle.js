...
var app = (function () {
	...
	: /*transitionDuration*/ ctx[6]}ms`;
    	...
    	const block = {
			...
			: /*transitionDuration*/ ctx[6]}ms`)) {
    			...
    			if (dirty[0] & /*passedThreshold*/ 1024) {
    				toggle_class(div1, "passed-threshold", /*passedThreshold*/ ctx[10]);
    			}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function up() {
    		...
    		$$invalidate(10, passedThreshold = false);
    	}

    	function move(event) {
    		if (!isDragging) return;
    		$$invalidate(10, passedThreshold = Math.abs(currentScrollPosition - finalScrollPosition) > threshold);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('passedThreshold' in $$props) $$invalidate(10, passedThreshold = $$props.passedThreshold);
