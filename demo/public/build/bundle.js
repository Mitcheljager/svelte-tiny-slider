...
var app = (function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-1bhvovo");
    			add_location(img, file, 59, 7, 1760);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "item no-gap svelte-1bhvovo");
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 66, 6, 1902);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 70, 6, 2056);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_controls_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			t8 = text(t8_value);
    			add_location(div0, file, 73, 5, 2159);
    			add_location(div1, file, 74, 5, 2184);
    			add_location(div2, file, 75, 5, 2212);
    			add_location(div3, file, 76, 5, 2253);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(84:2) {#each { length: 20 } as _}",
    		ctx
    	});
    ...
    // (83:1) <TinySlider gap="0.5rem" fill={false} let:setIndex let:currentIndex let:shown>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(83:1) <TinySlider gap=\\\"0.5rem\\\" fill={false} let:setIndex let:currentIndex let:shown>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div2, "class", "wrapper svelte-1bhvovo");
    			add_location(div2, file, 25, 0, 659);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
