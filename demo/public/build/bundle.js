...
var app = (function () {
    ...
    function create_each_block_2(ctx) {
    	...
    	let img_src_value;
    	let t;
    	let style___width = `${/*galleryWidth*/ ctx[9]}px`;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-um8ift");
    			add_location(img, file, 41, 4, 1483);
    			attr_dev(div, "class", "item svelte-um8ift");
    			set_style(div, "--width", style___width, false);
    			set_style(div, "--height", `400px`, false);
    			add_location(div, file, 37, 3, 1388);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*galleryWidth*/ 512 && style___width !== (style___width = `${/*galleryWidth*/ ctx[9]}px`)) {
    				set_style(div, "--width", style___width, false);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    // (36:1) <TinyGallery bind:setIndex let:currentIndex let:galleryWidth>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*galleryWidth, items*/ 514) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(36:1) <TinyGallery bind:setIndex let:currentIndex let:galleryWidth>",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-um8ift");
    			add_location(img, file, 52, 5, 1747);
    			attr_dev(button, "class", "dot svelte-um8ift");
    			toggle_class(button, "active", /*i*/ ctx[14] == /*currentIndex*/ ctx[8]);
    			add_location(button, file, 47, 4, 1605);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_controls_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "dots svelte-um8ift");
    			add_location(div, file, 45, 2, 1536);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-um8ift");
    			add_location(img, file, 67, 6, 2137);
    			attr_dev(div, "class", "item svelte-um8ift");
    			set_style(div, "--width", `200px`, false);
    			add_location(div, file, 66, 5, 2089);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    ...
    // (65:3) <TinyGallery let:setIndex let:currentIndex let:galleryWidth>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(65:3) <TinyGallery let:setIndex let:currentIndex let:galleryWidth>",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			button.textContent = "←";
    			attr_dev(button, "class", "arrow left svelte-um8ift");
    			add_location(button, file, 73, 6, 2266);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			button.textContent = "→";
    			attr_dev(button, "class", "arrow right svelte-um8ift");
    			add_location(button, file, 77, 6, 2420);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	function tinygallery0_setIndex_binding(value) {
    		/*tinygallery0_setIndex_binding*/ ctx[5](value);
    	}

    	let tinygallery0_props = {
    		$$slots: {
    			controls: [
    				create_controls_slot_1,
    				({ currentIndex, galleryWidth }) => ({ 8: currentIndex, 9: galleryWidth }),
    				({ currentIndex, galleryWidth }) => (currentIndex ? 256 : 0) | (galleryWidth ? 512 : 0)
    			],
    			default: [
    	...
    	if (/*setIndex*/ ctx[0] !== void 0) {
    		tinygallery0_props.setIndex = /*setIndex*/ ctx[0];
    	}

    	tinygallery0 = new TinyGallery({
    			props: tinygallery0_props,
    			$$inline: true
    		});

    	binding_callbacks.push(() => bind(tinygallery0, 'setIndex', tinygallery0_setIndex_binding));
    			...
    			props: {
    				$$slots: {
    					controls: [
    						...
    						({ setIndex, currentIndex, galleryWidth }) => (setIndex ? 1 : 0) | (currentIndex ? 256 : 0) | (galleryWidth ? 512 : 0)
    					],
    					default: [
    						create_default_slot,
    						({ setIndex, currentIndex, galleryWidth }) => ({
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "gallery-wrapper svelte-um8ift");
    			add_location(div0, file, 63, 2, 1954);
    			attr_dev(div1, "class", "relative svelte-um8ift");
    			add_location(div1, file, 62, 1, 1928);
    			attr_dev(div2, "class", "wrapper svelte-um8ift");
    			add_location(div2, file, 34, 0, 1273);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(tinygallery0, div2, null);
    			append_dev(div2, t);
    			append_dev(div2, div1);
    			append_dev(div1, div0);
    			mount_component(tinygallery1, div0, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const tinygallery0_changes = {};

    			if (dirty & /*$$scope, currentIndex, setIndex, galleryWidth*/ 131841) {
    				tinygallery0_changes.$$scope = { dirty, ctx };
    			}

    			if (!updating_setIndex && dirty & /*setIndex*/ 1) {
    				updating_setIndex = true;
    				tinygallery0_changes.setIndex = /*setIndex*/ ctx[0];
