...
var app = (function () {
	...
	: /*transitionDuration*/ ctx[6]}ms`;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "slider-content svelte-54x6yi");
    			...
    			add_location(div0, file$1, 125, 2, 3319);
    			...
    			add_location(div1, file$1, 124, 0, 3210);
    		},
    ...
    function create_each_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = /*item*/ ctx[20])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-i5eghr");
    			add_location(img, file, 33, 5, 951);
    			attr_dev(div, "class", "item svelte-i5eghr");
    			set_style(div, "--width", style___width, false);
    			set_style(div, "--height", `400px`, false);
    			add_location(div, file, 29, 4, 853);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_2(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[6](/*setIndex*/ ctx[14], /*i*/ ctx[24]);
    	}

    	function focus_handler() {
    		return /*focus_handler*/ ctx[7](/*setIndex*/ ctx[14], /*i*/ ctx[24]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-i5eghr");
    			add_location(img, file, 44, 6, 1240);
    			attr_dev(button, "class", "dot svelte-i5eghr");
    			toggle_class(button, "active", /*i*/ ctx[24] == /*currentIndex*/ ctx[15]);
    			add_location(button, file, 39, 5, 1093);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_controls_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "dots svelte-i5eghr");
    			add_location(div, file, 37, 3, 1022);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    // (61:6) {#if [index, index + 1, index - 1].some(i => shown.includes(i))}
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-i5eghr");
    			add_location(img, file, 61, 7, 1814);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*portaitItems*/ 1 && !src_url_equal(img.src, img_src_value = /*item*/ ctx[20])) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(61:6) {#if [index, index + 1, index - 1].some(i => shown.includes(i))}",
    		ctx
    	});
    ...
    // (59:4) {#each portaitItems as item, index}
    function create_each_block_1(ctx) {
    	let div;
    	let show_if = [/*index*/ ctx[22], /*index*/ ctx[22] + 1, /*index*/ ctx[22] - 1].some(func);
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "item no-gap svelte-i5eghr");
    			set_style(div, "--width", `200px`, false);
    			set_style(div, "--height", `300px`, false);
    			add_location(div, file, 59, 5, 1663);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*shown*/ 65536) show_if = [/*index*/ ctx[22], /*index*/ ctx[22] + 1, /*index*/ ctx[22] - 1].some(func);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:4) {#each portaitItems as item, index}",
    		ctx
    	});
    ...
    // (58:3) <TinySlider gap="0.5rem" let:setIndex let:currentIndex let:shown bind:sliderWidth bind:currentScrollPosition bind:maxWidth>
    function create_default_slot_1(ctx) {
    	let each_1_anchor;
    	let each_value_1 = /*portaitItems*/ ctx[0];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*portaitItems, shown*/ 65537) {
    				each_value_1 = /*portaitItems*/ ctx[0];
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(58:3) <TinySlider gap=\\\"0.5rem\\\" let:setIndex let:currentIndex let:shown bind:sliderWidth bind:currentScrollPosition bind:maxWidth>",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			button.textContent = "←";
    			attr_dev(button, "class", "arrow left svelte-i5eghr");
    			add_location(button, file, 68, 6, 1956);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    // (72:5) {#if currentIndex < portaitItems.length - 1}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			button.textContent = "→";
    			attr_dev(button, "class", "arrow right svelte-i5eghr");
    			add_location(button, file, 72, 6, 2110);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(72:5) {#if currentIndex < portaitItems.length - 1}",
    		ctx
    	});
    ...
    // (67:4) <svelte:fragment slot="controls">
    function create_controls_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			t8 = text(t8_value);
    			add_location(div0, file, 75, 5, 2213);
    			add_location(div1, file, 76, 5, 2238);
    			add_location(div2, file, 77, 5, 2266);
    			add_location(div3, file, 78, 5, 2307);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(67:4) <svelte:fragment slot=\\\"controls\\\">",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(86:2) {#each { length: 20 } as _}",
    		ctx
    	});
    ...
    // (85:1) <TinySlider gap="0.5rem" fill={false} let:setIndex let:currentIndex let:shown>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(85:1) <TinySlider gap=\\\"0.5rem\\\" fill={false} let:setIndex let:currentIndex let:shown>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "gallery");
    			add_location(div0, file, 26, 1, 683);
    			attr_dev(div1, "class", "slider-wrapper svelte-i5eghr");
    			add_location(div1, file, 56, 2, 1459);
    			attr_dev(div2, "class", "relative svelte-i5eghr");
    			add_location(div2, file, 55, 1, 1433);
    			attr_dev(div3, "class", "wrapper svelte-i5eghr");
    			add_location(div3, file, 25, 0, 659);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div3, t1);
    			mount_component(tinyslider2, div3, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const tinyslider0_changes = {};

    			if (dirty & /*$$scope, currentIndex, setIndex, sliderWidth*/ 134266888) {
    			...
    			if (dirty & /*$$scope, portaitItems, currentScrollPosition, maxWidth, shown, setIndex, currentIndex*/ 134332423) {
