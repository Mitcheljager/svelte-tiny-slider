...
var app = (function () {
    ...
    const get_controls_slot_changes = dirty => ({ active: dirty & /*active*/ 1 });
    const get_controls_slot_context = ctx => ({ active: /*active*/ ctx[0] });
	...
	: /*transitionDuration*/ ctx[5]}ms`;
    	...
    	const controls_slot_template = /*#slots*/ ctx[10].controls;
    	const controls_slot = create_slot(controls_slot_template, ctx, /*$$scope*/ ctx[9], get_controls_slot_context);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "gallery svelte-18pwmwt");
    			set_style(div0, "transform", style_transform, false);
    			set_style(div0, "transition-duration", style_transition_duration, false);
    			add_location(div0, file$1, 71, 2, 1740);
    			attr_dev(div1, "class", "gallery-wrapper svelte-18pwmwt");
    			add_location(div1, file$1, 70, 0, 1673);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window_1, "mousedown", /*down*/ ctx[6], false, false, false),
    					listen_dev(window_1, "mouseup", /*up*/ ctx[7], false, false, false),
    					listen_dev(window_1, "mousemove", /*move*/ ctx[8], false, false, false)
    				];
			...
			: /*transitionDuration*/ ctx[5]}ms`)) {
    			...
    			if (controls_slot) {
    				if (controls_slot.p && (!current || dirty & /*$$scope, active*/ 513)) {
    					update_slot_base(
    						controls_slot,
    						...
    						!current
    						? get_all_dirty_from_scope(/*$$scope*/ ctx[9])
    						: get_slot_changes(controls_slot_template, /*$$scope*/ ctx[9], dirty, get_controls_slot_changes),
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function snapToPosition() {
    		...
    		$$invalidate(0, active += currentScrollPosition > finalScrollPosition ? 1 : -1);
    		console.log(active);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<TinyGallery> was created with unknown prop '${key}'`);
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			if (!src_url_equal(img.src, img_src_value = /*item*/ ctx[3])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file, 17, 4, 495);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:3) {#each items as item}",
    		ctx
    	});
    ...
    function create_controls_slot(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[1](/*active*/ ctx[2]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 24, 3, 601);
    			attr_dev(div1, "slot", "controls");
    			add_location(div1, file, 21, 2, 560);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, t0);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*active*/ 4 && t0_value !== (t0_value = /*active*/ ctx[2] + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div1);
    			mounted = false;
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 13, 0, 394);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = active => console.log(active);
    	$$self.$capture_state = () => ({ TinyGallery, items });
