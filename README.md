...
| vertical | true | Boolean to set use vertical scrolling rather than left to right. |
...
| sliderHeight | 0 | Box height in pixels of the slider as it is on the page (Read only). |
| maxWidth | 0 | Full width in pixels of all items together (Read only). |
| maxHeight | 0 | Full height in pixels of all items together (Read only). |
